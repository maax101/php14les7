...
imagettftext($sert, 22, 0, 200, 50, $text_col, $font, 'Ваш результат, '.$user.':');
imagettftext($sert, 15,0, 50, 100,$text_col,$font, 'правильно: '.$ot);
imagettftext($sert, 15,0, 50, 150,$text_col,$font, 'неправильно: '.$not);
...
>>>>>>> 5c98cec2b3d433f0214b4ec8292f9127f13bfb72
</html>